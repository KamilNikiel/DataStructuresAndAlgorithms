...
using DataStructuresAndAlgorithms.StringManipulation;
...
namespace DataStructuresAndAlgorithms
{
    internal static class Examples
    {
        ...
        private static void StringManipulationUtilites()
        {
            var str = "hello";
            var sentence = "This trees are beutiful";
            var potentialWord = "Kajak";
            Console.Write("Count vowels: ");
            Console.WriteLine(StringUtils.CountVowels(str));
            Console.Write("Reverse: ");
            Console.WriteLine(StringUtils.Reverse(str));
            Console.Write("Reverse words: ");
            Console.WriteLine(StringUtils.ReverseWords(sentence));
            Console.Write("Rotations: ");
            Console.WriteLine(StringUtils.AreRotations("abcd", "cdab"));
            Console.Write("Remove duplicates: ");
            Console.WriteLine(StringUtils.RemoveDuplicates(str));
            Console.Write("Most repeated char: ");
            Console.WriteLine(StringUtils.MostRepeatedCharDictionary(str));
            Console.Write("Most repeated char: ");
            Console.WriteLine(StringUtils.MostRepeatedChar(str));
            Console.Write("Capitilize: ");
            Console.WriteLine(StringUtils.Capitalize("This       trees are beutiful"));
            Console.Write("Anagrams: ");
            Console.WriteLine(StringUtils.AreAnagrams("cdab", "abcd"));
            Console.Write("Anagrams: ");
            Console.WriteLine(StringUtils.AreAnagramsHistogramming("cdab", "abcd"));
            Console.Write($"Is {potentialWord} palindrome: ");
            Console.WriteLine(StringUtils.IsPalindrome(potentialWord));
        }
